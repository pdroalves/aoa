 ...
 */
CKKSKeychain* ckks_keygen(CKKSContext *ctx, SecretKey *sk);
 ...
 * @return     The encryption of m
 */
cipher_t* ckks_encrypt(CKKSContext *ctx, std::complex<double>* val, int slots = 1, int empty_slots = 0);
 ...
 * @return     The encryption of m
 */
cipher_t* ckks_encrypt(CKKSContext *ctx, cipher_t *ct, std::complex<double>* val, int slots = 1, int empty_slots = 0);
 ...
 * @return     Message m
 */
 std::complex<double>* ckks_decrypt(CKKSContext *ctx, cipher_t *c, SecretKey *sk);
 ...
 * @return     Message m
 */
 std::complex<double>* ckks_decrypt(CKKSContext *ctx, std::complex<double>* val, cipher_t *c, SecretKey *sk);
...
__host__ cipher_t* ckks_mul_without_rescale( CKKSContext *ctx, cipher_t *c1, double val);

void ckks_mul(CKKSContext *ctx, cipher_t *c2, cipher_t *c1, std::complex<double> *val);

cipher_t* ckks_mul(CKKSContext *ctx, cipher_t *c1, std::complex<double> *val);
